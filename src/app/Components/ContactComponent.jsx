...
const ContactComponent = () => {
  return (
    ...
    ">
      <h3 className="text-start font-semibold block w-[95%] mx-auto mb-2 text-sm"> Deja tu Propuesta o Proyecto </h3>
      ...
      <div className="flex flex-row w-full items-center justify-center gap-x-2">
        ...
        <input type="text" className=" block w-[95%] mx-auto rounded-lg bg-[#4F5D98] mb-1 placeholder:text-gray-300 placeholder:text-xs placeholder:absolute placeholder:top-2 placeholder:left-2 text-sm text-left p-2 " placeholder="Mensaje"/>
