...
const page = () => {
    return (
        <main className='grid grid-cols-12 sm:grid-rows-12  p-2 gap-2
        ...
        2xl:bg-yellow-400'>
            ...
            <article className='border-2 border-black rounded-lg 
                                ...
                                lg:row-span-3 lg:col-span-6
                                xl:row-span-3 
                                2xl:col-span-8 2xl:row-span-4       
                               '>
                12
            </article>
